...
const DICT: Dict = {
  ...
  imports_left_wk: { en: 'free imports left this week', de: 'freie Importe übrig diese Woche' },
  imports_used_wk: { en: 'weekly free imports used', de: 'freie Wochen-Importe aufgebraucht' },
  imports_unlimited: { en: 'unlimited with Pro', de: 'unbegrenzt mit Pro' },
