...
<div class="lp" bind:this={rootEl}>
  ...
  >
    <div class="lp-wrap lp-hero-grid">
      ...
      <p class="lp-tagline lp-in lp-i1">{t('lp_tag')}</p>
  ...
  <section class="lp-plans" id="plans" data-lp-band>
    <div class="lp-wrap">
      ...
      <div class="lp-footlinks" data-lp-reveal>
        <button class="lp-linklike" type="button" onclick={() => onGoto('science')}>
          {t('lp_foot_science')}
        </button>
        <span class="lp-dot-sep">·</span>
        <button class="lp-linklike" type="button" onclick={() => onGoto('impressum')}>Impressum</button>
        <span class="lp-dot-sep">·</span>
        <button class="lp-linklike" type="button" onclick={() => onGoto('datenschutz')}>Datenschutz</button>
      </div>
    </div>
  </section>
</div>
